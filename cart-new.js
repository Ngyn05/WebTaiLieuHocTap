...
function updateCartTotals(items) {
  ...
  const subtotalElements = document.querySelectorAll('#subtotal table tr:first-child td:nth-child(2)');
  const totalElements = document.querySelectorAll('#subtotal table tr:last-child td:nth-child(2) strong');

  subtotalElements.forEach((el) => {
    el.textContent = (typeof formatCurrencyVnd === 'function'
